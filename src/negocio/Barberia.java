...
public class Barberia {
	...
	//La barberia posee 5 sillas que son tambien las que se encuentran en el frontend
	...
	//retorna un boolean random donde se vera si hay cliente nuevo o no. 
	public boolean hayClienteNuevo() {
		Random ran = new Random();
		return ran.nextBoolean();
	}

	// llega cliente, y pregunta si el barbero esta dormido. 
